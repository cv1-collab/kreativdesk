import { bT as Book, bU as CirclePlay, F as FileText, v as Briefcase, j as jsxRuntimeExports, aM as Search, X, N as CircleQuestionMark, an as MessageSquare, g as Sparkles } from './vendor-ui-B7yEkTas.js';
import { r as reactExports, u as useNavigate } from './vendor-core-egDwzlzP.js';
...
function HelpCenter() {
  ...
  const categories = [
    ...
    { id: "bim-viewer", title: t("bim_viewer"), icon: CirclePlay, description: t("bim_viewer_desc"), searchTerm: "BIM" },
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full flex flex-col bg-background animate-in fade-in duration-500", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto p-4 md:p-8 custom-scrollbar", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto space-y-12", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl md:text-5xl font-bold text-text-primary tracking-tight", children: t("help_center") }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-text-muted", children: t("help_subtitle") }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto relative flex items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "absolute left-4 text-text-muted", size: 20 }),
    ...
    !searchQuery && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: categories.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(cat.icon, { size: 24, className: "text-accent-ai mb-4" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-lg text-text-primary mb-2 group-hover:text-accent-ai transition-colors", children: cat.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-text-muted leading-relaxed", children: cat.description })
        ]
      },
      cat.id
    )) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold text-text-primary", children: searchQuery ? "Search Results" : t("faq_title") }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        faqs.filter((faq) => faq.question.toLowerCase().includes(searchQuery.toLowerCase()) || faq.answer.toLowerCase().includes(searchQuery.toLowerCase())).map((faq, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 bg-surface border border-border rounded-xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h4", { className: "font-bold text-text-primary mb-2 flex items-start gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CircleQuestionMark, { className: "text-accent-ai shrink-0 mt-0.5", size: 20 }),
            faq.question
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-text-muted leading-relaxed ml-8", children: faq.answer })
        ] }, i)),
        searchQuery && faqs.filter((faq) => faq.question.toLowerCase().includes(searchQuery.toLowerCase()) || faq.answer.toLowerCase().includes(searchQuery.toLowerCase())).length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center p-8 border border-dashed border-border rounded-xl text-text-muted", children: [
    ...
    !searchQuery && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-12 p-8 bg-surface border border-border rounded-xl text-center space-y-4 shadow-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-full bg-background border border-border flex items-center justify-center mx-auto mb-2 shadow-inner", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MessageSquare, { size: 24, className: "text-accent-ai" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-text-primary", children: t("still_need_help") }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-text-muted text-sm max-w-md mx-auto leading-relaxed", children: t("support_desc") }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-4 flex flex-col sm:flex-row items-center justify-center gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "px-6 py-2.5 bg-text-primary text-background rounded-xl text-sm font-bold shadow-lg transition-colors", children: t("contact_support") }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { size: 16, className: "text-accent-ai" }),
              t("ask_ai")
            ]
          }
        )
