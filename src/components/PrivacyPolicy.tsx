          ...
          <div className="space-y-16 leading-relaxed">
            ...
            <section>
              ...
              <div className="space-y-6">
                ...
                <div>
                  <p><strong>7. Einsatz von Drittanbietern und externen Diensten:</strong> Zur Bereitstellung und technischen Umsetzung der Systemarchitektur werden externe Dienstleister und Cloud-Dienste eingesetzt. Dabei können personenbezogene Daten an folgende Anbieter übermittelt oder durch diese verarbeitet werden: Supabase (PostgreSQL-Datenbank, Authentifizierung, Cloud-Speicher und Realtime-Engine; betrieben in der Region eu-central-2 Zurich in ISO-27001-zertifizierten Schweizer Rechenzentren), Google Analytics (Analyse und Optimierung der Plattformnutzung, Mess-ID G-60E5SSMTHR), Google Gemini (Für Text- und Bildanalyse sowie KI-Zusammenfassungen via API), fal.ai (Für KI-Bildgenerierung und visuelle Renderings), Stripe (Zahlungsabwicklung und Abonnementverwaltung), Vercel (Hosting und Deployment des Frontends), Hostinger (Domainverwaltung, Hosting und SMTP-E-Mail-Versand).</p>
                ...
                <div>
                  <p><strong>10. Datensicherheit & Serverstandort Schweiz:</strong> Unsere Cloud-Infrastruktur und relationalen Datenbanken werden dediziert in Zürich (Schweiz) in ISO-27001-zertifizierten Rechenzentren betrieben (PostgreSQL via Supabase Cloud, Region eu-central-2 Zurich). Sämtliche Projektdaten sind strikt mandantenisoliert (Row Level Security). Wir treffen angemessene technische und organisatorische Sicherheitsmassnahmen (TOM) zum Schutz personenbezogener Daten vor Verlust, Missbrauch, unberechtigtem Zugriff oder Offenlegung gemäss Schweizer Datenschutzgesetz (DSG) und DSGVO.</p>
                </div>
                <div>
                  <p><strong>11. Cookies und technische Informationen (Tracking):</strong> Die Plattform verwendet Cookies und vergleichbare lokale Speichertechnologien (wie LocalStorage und Session Tokens). Dabei unterscheiden wir strikt zwischen technisch zwingend notwendigen Daten (z. B. für den Login und die Session-Sicherheit via Supabase Auth) und optionalen Analysediensten (wie Google Analytics GA4). Technisch notwendige Speicherung: Erfolgt automatisch zur Sicherstellung des Plattformbetriebs. Analyse und Tracking: Der Einsatz von Analyse-Tools zur Auswertung des Nutzerverhaltens erfolgt ausschliesslich nach Ihrer ausdrücklichen Zustimmung (Opt-in) über unseren Consent-Manager. Weitere Details finden Sie in unserem separaten Cookie- und Tracking-Hinweis.</p>
                </div>
                <div>
          ...
          <div className="space-y-16 leading-relaxed">
            ...
            <section>
              ...
              <div className="space-y-6">
                ...
                <div>
                  <p><strong>7. Use of Third-Party Providers and External Services:</strong> External service providers and cloud services are used for the provision and technical implementation of the system architecture. In this context, personal data may be transmitted to or processed by the following providers: Supabase (PostgreSQL database, authentication, cloud storage, and realtime engine; operated in region eu-central-2 Zurich within ISO-27001 certified Swiss data centers), Google Analytics (Analysis and optimization of platform usage, Measurement ID G-60E5SSMTHR), Google Gemini (For text and image analysis, as well as AI summaries via API), fal.ai (For AI image generation and visual rendering), Stripe (Payment processing and subscription management), Vercel (Hosting and deployment of the frontend), Hostinger (Domain management, hosting, and SMTP email delivery).</p>
                ...
                <div>
                  <p><strong>10. Data Security & Swiss Server Location:</strong> Our cloud infrastructure and relational databases are operated dedicatedly in Zurich (Switzerland) within ISO-27001 certified data centers (PostgreSQL via Supabase Cloud, Region eu-central-2 Zurich). All project data is strictly isolated per tenant (Row Level Security). We implement appropriate technical and organizational security measures (TOM) to protect personal data against loss, misuse, unauthorized access, or disclosure in accordance with the Swiss Federal Act on Data Protection (FADP) and GDPR.</p>
                </div>
                <div>
                  <p><strong>11. Cookies and Technical Information (Tracking):</strong> The platform uses cookies and comparable local storage technologies (such as LocalStorage and Session Tokens). We strictly differentiate between technically mandatory data (e.g., for login and session security via Supabase Auth) and optional analytics services (such as Google Analytics GA4). Technically necessary storage: Occurs automatically to ensure platform operation. Analysis and tracking: The use of analytics tools to evaluate user behavior occurs exclusively upon your explicit consent (opt-in) via our Consent Manager. Further details can be found in our separate Cookie and Tracking Notice.</p>
                </div>
                <div>
            ...
            <section>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <ul className="list-disc pl-5 mt-2 space-y-2">
                    <li><strong>Strictly necessary services (e.g., Supabase Auth & Storage):</strong> These technologies are essential for the seamless operation of the SaaS platform. They handle session management, secure authentication (login), and core security mechanisms. This data processing is based on our legitimate interest in providing the platform.</li>
                    <li><strong>Analytics and performance tracking (Google Analytics GA4, ID G-60E5SSMTHR):</strong> These services help us collect aggregated data about user behavior to improve load times, UI/UX flows, and system architecture. The use of these tracking technologies occurs strictly upon your explicit consent (opt-in).</li>
                  </ul>
                </div>
                <div>
