...
const localTranslations: Record<'en' | 'de', Record<string, string>> = {
  en: {
    ...
    // Warum OS-Infrastruktur
    why_os_title: 'Why OS Infrastructure?',
    why_os_subtitle: 'The 4 executive pillars for maximum resilience, compliance, and enterprise value creation.',
    why_os_1_title: 'Central Macro-Controlling (Target vs. Actual)',
    why_os_1_desc: 'No more blind spots. Executive management oversees budgets, milestones, and resource utilization across the entire corporate portfolio in real-time.',
    why_os_2_title: 'Granular Access Management (RBAC)',
    why_os_2_desc: 'Owner, Management, Teamlead, Employee. Define exactly who can view financial data, budgets, or contracts. Absolute security for sensitive corporate data.',
    why_os_3_title: '100% Data Sovereignty & 1-Click Onboarding',
    why_os_3_desc: 'Knowledge never leaves the company. When employees change, all project data, 3D models, and histories remain centrally retained. Access can be revoked or reassigned instantly.',
    why_os_4_title: 'Native 3D & BIM Pipelines (In-House)',
    why_os_4_desc: 'Your spatial data and CAD models run natively through our architecture. No dependency on third-party viewers, zero data leaks. Full performance right in the browser.',

    // B2B Project Systems
    systems_title: 'Project Control Systems', systems_subtitle: 'Economic infrastructure for studios, agencies, and enterprises managing complex productions at scale.',
    sys1_title: 'Studio OS', sys1_desc: 'Focus: Establishing a central data architecture, tenant-isolated environment, and executive master dashboard.', sys1_price: 'from CHF 15,000', sys1_renewal: 'SETUP INCL. 1ST YR. FROM YR 2: CHF 7,500/YR', sys1_seats: 'Incl. 5 Governance Seats (+ CHF 780/yr per extra seat)',
    sys2_title: 'Agency OS', sys2_badge: 'EXECUTION BOOSTER', sys2_desc: 'Focus: Full resource controlling (target vs. actual), dedicated team workspaces, and automated on-/offboarding for maximum data security.', sys2_price: 'CHF 25,000', sys2_renewal: 'SETUP INCL. 1ST YR. FROM YR 2: CHF 19,500/YR', sys2_seats: 'Incl. 10 Governance Seats (+ CHF 780/yr per extra seat)',
    sys3_title: 'Enterprise OS', sys3_desc: 'Focus: Custom API pipelines, Single Sign-On (SSO), strategic onboarding, and unlimited system resources.', sys3_price: 'from CHF 50,000', sys3_renewal: 'SETUP INCL. 1ST YR. FROM YR 2: FROM CHF 35,000/YR', sys3_seats: 'Incl. 20 Governance Seats (+ CHF 780/yr per extra seat)',
    ...
    help_subtitle: 'Have questions about implementation, B2B models, or technical integrations? Our Swiss engineering team is here for you.',
    help_search_placeholder: 'Search for answers (e.g. BIM, renewal, RBAC, licenses)...',
    ...
    help_no_results: 'No matching topics found. Try searching for "BIM", "Lizenzen" or "Support".',
  ...
  de: {
    ...
    // Warum OS-Infrastruktur
    why_os_title: 'Warum OS-Infrastruktur?',
    why_os_subtitle: 'Die 4 Säulen für maximale Ausfallsicherheit, Compliance und Wertschöpfung in Ihrem Unternehmen.',
    why_os_1_title: 'Zentrales Makro-Controlling (Soll vs. Ist)',
    why_os_1_desc: 'Keine toten Winkel mehr. Die Geschäftsleitung überwacht Budgets, Meilensteine und Ressourcen-Auslastung über das gesamte Firmen-Portfolio hinweg in Echtzeit.',
    why_os_2_title: 'Granulares Access Management (RBAC)',
    why_os_2_desc: 'Owner, Management, Teamlead, Mitarbeiter. Definieren Sie exakt, wer Finanzdaten, Budgets oder Verträge sehen darf. Absolute Sicherheit für sensible Unternehmensdaten.',
    why_os_3_title: '100% Datenhoheit & 1-Klick Onboarding',
    why_os_3_desc: 'Wissen verlässt niemals die Firma. Wenn Mitarbeiter wechseln, bleiben alle Projektdaten, 3D-Modelle und Historien zentral im System. Zugriffe lassen sich zentral entziehen oder neu zuweisen.',
    why_os_4_title: 'Native 3D- & BIM-Pipelines (In-House)',
    why_os_4_desc: 'Ihre räumlichen Daten und CAD-Modelle laufen nativ über unsere Architektur. Keine Abhängigkeit von externen Drittanbieter-Viewern, keine Daten-Lecks. Volle Performance, direkt im Browser.',

    // B2B Projekt-Systeme
    systems_title: 'Projekt-Steuerungssysteme (Kreativ-Desk OS)', systems_subtitle: 'Wirtschaftliche Infrastruktur für Studios, Agenturen und Generalunternehmungen, die komplexe Produktionen skalierbar steuern müssen.',
    sys1_title: 'Studio OS', sys1_desc: 'Fokus: Etablierung einer zentralen Datenstruktur, mandantenisolierte Umgebung und Master-Dashboard für die Geschäftsleitung.', sys1_price: 'ab CHF 15’000', sys1_renewal: 'SETUP INKL. 1. JAHR. AB JAHR 2: CHF 7’500/JAHR', sys1_seats: 'Inkl. 5 Governance-Lizenzen (+ CHF 780/Jahr pro Zusatzlizenz)',
    sys2_title: 'Agency OS', sys2_badge: 'EXECUTION BOOSTER', sys2_desc: 'Fokus: Volles Ressourcen-Controlling (Soll vs. Ist), dedizierte Team-Workspaces und automatisches On-/Offboarding für maximale Datensicherheit.', sys2_price: 'CHF 25’000', sys2_renewal: 'SETUP INKL. 1. JAHR. AB JAHR 2: CHF 19’500/JAHR', sys2_seats: 'Inkl. 10 Governance-Lizenzen (+ CHF 780/Jahr pro Zusatzlizenz)',
    sys3_title: 'Enterprise OS', sys3_desc: 'Fokus: Custom API-Pipelines, Single Sign-On (SSO), strategisches Onboarding und unlimitierte Systemressourcen.', sys3_price: 'ab CHF 50’000', sys3_renewal: 'SETUP INKL. 1. JAHR. AB JAHR 2: AB CHF 35’000/JAHR', sys3_seats: 'Inkl. 20 Governance-Lizenzen (+ CHF 780/Jahr pro Zusatzlizenz)',
    ...
    help_subtitle: 'Hast du Fragen zur Implementierung, unseren B2B-Modellen oder technischen Integrationen? Unser Schweizer Entwicklerteam ist für dich da.',
    help_search_placeholder: 'Nach Antworten suchen (z.B. BIM, Folgejahr, RBAC, Lizenzen)...',
    ...
    help_no_results: 'Keine passenden Themen gefunden. Versuche z.B. nach "BIM", "Lizenzen" oder "Support" zu suchen.',
  ...
  return (
    <div className="min-h-screen bg-background text-text-primary selection:bg-blue-500/30 overflow-x-hidden">
      ...
      <header className={cn(
        ...
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center gap-8">
            ...
            <button onClick={() => scrollTo('help-center')} className="text-sm font-bold text-text-muted hover:text-text-primary transition-colors">{t('nav_help')}</button>
        ...
        {isMenuOpen && (
          <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} className="fixed inset-0 z-[90] bg-background pt-24 px-6 lg:hidden border-b border-border shadow-2xl pb-6 h-fit">
            <div className="flex flex-col gap-4">
               ...
               <button onClick={() => scrollTo('faq')} className="text-left text-lg font-bold p-2 border-b border-border/50">{t('nav_faq')}</button>
               <button onClick={() => scrollTo('help-center')} className="text-left text-lg font-bold p-2 border-b border-border/50">{t('nav_help')}</button>
      ...
      <main>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
              ...
              <div className="p-8 sm:p-10 bg-gradient-to-br from-red-950/20 via-surface to-background border border-red-500/30 rounded-[2.5rem] shadow-xl flex flex-col justify-between relative overflow-hidden group">
                ...
                <div className="space-y-3 bg-background/60 backdrop-blur-md p-5 rounded-2xl border border-red-500/20">
              ...
              <div className="p-8 sm:p-10 bg-gradient-to-br from-blue-950/20 via-surface to-background border border-blue-500/40 rounded-[2.5rem] shadow-2xl flex flex-col justify-between relative overflow-hidden group">
                ...
                <div>
                  ...
                  <h3 className="text-2xl sm:text-3xl font-black text-blue-400 mb-4 tracking-tight">
                    {t('ssot_title')}
                  </h3>
                  <p className="text-text-muted text-sm sm:text-base leading-relaxed mb-8">
                    {t('ssot_desc')}
                ...
                <div className="p-6 bg-background/60 backdrop-blur-md rounded-2xl border border-blue-500/20 flex flex-col items-center justify-center text-center relative overflow-hidden">
                  <div className="w-16 h-16 rounded-2xl bg-blue-600/20 border border-blue-500/40 flex items-center justify-center text-blue-400 mb-4 shadow-lg shadow-blue-500/10">
        ...
        {/* 2. WARUM OS-INFRASTRUKTUR (4 SÄULEN FÜR DIE GESCHÄFTSLEITUNG) */}
        <section id="infrastructure" className="py-24 px-6 bg-surface/20 border-y border-border">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-black tracking-tighter mb-4">{t('why_os_title')}</h2>
              <p className="text-lg text-text-muted font-medium max-w-3xl mx-auto">{t('why_os_subtitle')}</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              
              {/* Säule 1 */}
              <div className="p-8 sm:p-10 bg-surface border border-border rounded-[2.5rem] hover:border-blue-500/40 transition-colors flex flex-col justify-between group shadow-sm">
                <div>
                  ...
                  <h3 className="text-xl sm:text-2xl font-bold mb-3">{t('why_os_1_title')}</h3>
                  <p className="text-text-muted text-sm sm:text-base leading-relaxed">{t('why_os_1_desc')}</p>
                </div>
              </div>

              {/* Säule 2 */}
              <div className="p-8 sm:p-10 bg-surface border border-border rounded-[2.5rem] hover:border-emerald-500/40 transition-colors flex flex-col justify-between group shadow-sm">
                <div>
                  ...
                  <h3 className="text-xl sm:text-2xl font-bold mb-3">{t('why_os_2_title')}</h3>
                  <p className="text-text-muted text-sm sm:text-base leading-relaxed">{t('why_os_2_desc')}</p>
                </div>
              </div>

              {/* Säule 3 */}
              <div className="p-8 sm:p-10 bg-surface border border-border rounded-[2.5rem] hover:border-purple-500/40 transition-colors flex flex-col justify-between group shadow-sm">
                <div>
                  <div className="w-12 h-12 rounded-2xl bg-purple-500/10 border border-purple-500/20 flex items-center justify-center text-purple-500 mb-6 group-hover:scale-110 transition-transform">
                    <Users size={24} />
                  </div>
                  <h3 className="text-xl sm:text-2xl font-bold mb-3">{t('why_os_3_title')}</h3>
                  <p className="text-text-muted text-sm sm:text-base leading-relaxed">{t('why_os_3_desc')}</p>
                </div>
              </div>

              {/* Säule 4 */}
              <div className="p-8 sm:p-10 bg-surface border border-border rounded-[2.5rem] hover:border-indigo-500/40 transition-colors flex flex-col justify-between group shadow-sm">
                <div>
                  <div className="w-12 h-12 rounded-2xl bg-indigo-500/10 border border-indigo-500/20 flex items-center justify-center text-indigo-500 mb-6 group-hover:scale-110 transition-transform">
                    <Box size={24} />
                  </div>
                  <h3 className="text-xl sm:text-2xl font-bold mb-3">{t('why_os_4_title')}</h3>
                  <p className="text-text-muted text-sm sm:text-base leading-relaxed">{t('why_os_4_desc')}</p>
                </div>
              </div>
        ...
        <section id="systems" className="py-32 px-6">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-20">
                ...
                <p className="text-xl text-text-muted max-w-3xl mx-auto">{t('systems_subtitle')}</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
                {/* Studio OS */}
                <div className="p-8 sm:p-10 bg-background border border-border hover:bg-surface/50 rounded-[2.5rem] transition-colors flex flex-col group shadow-sm">
                    ...
                    <div className="text-[10px] font-bold text-text-muted uppercase tracking-widest mb-3 p-1.5 bg-surface rounded border border-border self-start">{t('sys1_renewal')}</div>
                    <div className="text-xs font-semibold text-blue-500 mb-8">{t('sys1_seats')}</div>
                ...
                {/* Agency OS */}
                <div className="p-8 sm:p-10 bg-surface border border-blue-500/50 shadow-2xl md:scale-105 rounded-[2.5rem] relative flex flex-col group z-10">
                    <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-blue-600 text-white text-[10px] font-bold px-4 py-1.5 rounded-full uppercase tracking-widest shadow-md shadow-blue-500/20">{t('sys2_badge')}</div>
                    ...
                    <div className="text-[10px] font-bold text-blue-500 uppercase tracking-widest mb-3 p-1.5 bg-blue-500/10 rounded border border-blue-500/20 self-start">{t('sys2_renewal')}</div>
                ...
                <div className="p-8 sm:p-10 bg-background border border-border hover:bg-surface/50 rounded-[2.5rem] transition-colors flex flex-col group shadow-sm">
                    ...
                    <div className="text-[10px] font-bold text-text-muted uppercase tracking-widest mb-3 p-1.5 bg-surface rounded border border-border self-start">{t('sys3_renewal')}</div>
                    <div className="text-xs font-semibold text-emerald-500 mb-8">{t('sys3_seats')}</div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="max-w-2xl mx-auto mb-16 relative">
              <div className="relative flex items-center">
                ...
                />
                {helpSearch && (
                  <button onClick={() => setHelpSearch('')} className="absolute right-4 p-1.5 text-text-muted hover:text-text-primary rounded-lg">
                    <X size={16} />
                  </button>
                )}
              </div>
