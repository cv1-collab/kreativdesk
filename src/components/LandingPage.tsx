              ...
              <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden border border-white/20 dark:border-white/10 bg-slate-950/90 backdrop-blur-xl shadow-2xl">
                ...
                <div className="relative aspect-video w-full overflow-hidden bg-black flex items-center justify-center">
                  ...
                  <div className="hidden sm:flex absolute inset-x-0 bottom-0 p-5 sm:p-7 bg-gradient-to-t from-black/95 via-black/50 to-transparent flex-col sm:flex-row sm:items-end justify-between gap-3 pointer-events-none">
                    <div>
                      <div className="text-white font-bold text-lg sm:text-2xl tracking-tight mb-1 flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
              ...
              <div className="p-6 sm:p-8 md:p-10 bg-gradient-to-br from-red-500/5 via-surface to-background dark:from-red-950/20 dark:via-surface dark:to-background border border-red-500/30 rounded-3xl sm:rounded-[2.5rem] shadow-xl flex flex-col justify-between relative overflow-hidden group">
                ...
                <div>
                  ...
                  <h3 className="text-2xl sm:text-3xl font-bold text-red-600 dark:text-red-500 mb-4 tracking-tight">
                    {t('chaos_title')}
                  </h3>
              ...
              <div className="p-6 sm:p-8 md:p-10 bg-gradient-to-br from-blue-500/5 via-surface to-background dark:from-blue-950/20 dark:via-surface dark:to-background border border-blue-500/40 rounded-3xl sm:rounded-[2.5rem] shadow-2xl flex flex-col justify-between relative overflow-hidden group">
                ...
                <div className="p-4 sm:p-6 bg-blue-50/90 dark:bg-blue-500/10 border border-blue-200 dark:border-blue-500/30 rounded-2xl flex items-center gap-4 sm:gap-5">
                  ...
                  <div className="min-w-0">
                    <div className="font-bold text-sm sm:text-base text-slate-900 dark:text-text-primary mb-0.5 truncate">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="lg:hidden">
              <div className="text-center mb-6">
                ...
                <h2 className="text-2xl sm:text-3xl font-bold tracking-tight mb-2">{t('demo_title')}</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
            <div className="md:col-span-2">
              <div className="flex items-center gap-2 mb-4">
                <div className="w-8 h-8 bg-blue-600 text-white rounded-lg flex items-center justify-center font-bold text-sm">K</div>
