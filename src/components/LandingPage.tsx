...
import { 
  ...
  AlertTriangle, Bot, Send, Copy, CheckCheck
} from 'lucide-react';
...
const localTranslations: Record<'en' | 'de', Record<string, string>> = {
  en: {
    ...
    chaos_badge: 'Tool Chaos & Risk',
    chaos_title: 'Status Quo: Chaos & Tool Sprawl',
    chaos_desc: 'Fragmented point solutions, outdated spreadsheets, and scattered communication across emails, WhatsApp, and Dropbox: When contractors build on outdated blueprints, budget overruns remain hidden until invoices arrive, and critical project know-how is lost during team turnover, profit margins erode and liability risks skyrocket.',
  ...
  de: {
    ...
    // Status Quo vs Single Source of Truth
    chaos_badge: 'Tool-Chaos & Margenrisiko',
    chaos_title: 'Status Quo: Chaos & Tool-Wildwuchs',
    chaos_desc: 'Zersplitterte Insellösungen, veraltete Tabellen und unkoordinierte Kommunikation über E-Mail, WhatsApp und Dropbox: Wenn auf der Baustelle nach alten Planständen gebaut wird, Budgets erst beim Rechnungseingang platzen und wichtiges Know-how bei Mitarbeiterwechseln verloren geht, schmelzen Margen dahin und das Haftungsrisiko steigt massiv.',
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="lg:hidden">
              <div className="text-center mb-8">
                ...
                <h2 className="text-3xl font-black tracking-tight mb-2">{t('demo_title')}</h2>
