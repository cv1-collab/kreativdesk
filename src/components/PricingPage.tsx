...
const localTranslations: Record<'en' | 'de', Record<string, string>> = {
  en: {
    ...
    sys2_seats: 'Incl. 15 Governance Seats (+ CHF 780/yr per extra seat)',
    ...
    sys3_seats: 'Incl. 25 Governance Seats (+ CHF 780/yr per extra seat)',
    sys_vat: 'excl. VAT',
  ...
  de: {
    ...
    sys2_seats: 'Inkl. 15 Governance-Lizenzen (+ CHF 780/Jahr pro Zusatzlizenz)',
    sys3_title: 'Enterprise OS',
    ...
    sys3_seats: 'Inkl. 25 Governance-Lizenzen (+ CHF 780/Jahr pro Zusatzlizenz)',
    sys_vat: 'exkl. MwSt.',
